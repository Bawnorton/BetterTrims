...
public final class JukeboxPlayableExactAdder implements ExactAdder<JukeboxPlayable> {
	@Override
	public void addToBuilder(ClientLevel level, JukeboxPlayable object, LootConditionTooltips.State state, CompositeContainerComponent.Builder builder) {
		// TODO
	}
}
