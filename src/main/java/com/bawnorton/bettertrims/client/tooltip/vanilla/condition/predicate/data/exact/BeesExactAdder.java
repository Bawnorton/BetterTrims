...
public final class BeesExactAdder implements ExactAdder<Bees> {
	@Override
	public void addToBuilder(ClientLevel level, Bees object, LootConditionTooltips.State state, CompositeContainerComponent.Builder builder) {
		// TODO
	}
}
//?}