...
@Configurable(value = "orichalcum", yacl = @Yacl(type = OptionType.GAME_RESTART, image = @Image(custom = "getImage"), collapsed = true))
public final class OrichalcumTrimEffect extends TrimEffect {
    ...
    public static CompletableFuture<Optional<ImageRenderer>> getImage() {
        return getImageFor(AdditionalItemTags.ORICHALCUM_INGOTS);
    }
}
