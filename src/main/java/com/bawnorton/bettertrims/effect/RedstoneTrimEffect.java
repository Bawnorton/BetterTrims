...
public final class RedstoneTrimEffect extends TrimEffect {
    ...
    @Configurable(value = "movement_speed", min = 0, max = 16, yacl = @Yacl(formatter = "com.bawnorton.bettertrims.client.BetterTrimsClient#twoDpFormatter"))
    public static float movementSpeed = 0.1f;
    @Configurable(value = "step_height", min = 0, max = 16, yacl = @Yacl(formatter = "com.bawnorton.bettertrims.client.BetterTrimsClient#twoDpFormatter"))
