...
public abstract class ArmorTrimEffects {
    ...
    public static final ArmorTrimEffect DRAGONS_BREATH = of(TrimMaterial.of(Items.DRAGON_BREATH).or(TrimMaterial.of("dragon")), () -> ConfigManager.getConfig().enableDragonsBreath);
    ...
    public static final ArmorTrimEffect ECHO_SHARD = of(TrimMaterial.of(Items.ECHO_SHARD).or(TrimMaterial.of("echo")), () -> ConfigManager.getConfig().enableEchoShard);
    public static final ArmorTrimEffect ENDER_PEARL = of(TrimMaterial.of(Items.ENDER_PEARL).or(TrimMaterial.of("ender")), () -> ConfigManager.getConfig().enableEnderPearl);
    public static final ArmorTrimEffect FIRE_CHARGE = of(TrimMaterial.of(Items.FIRE_CHARGE).or(TrimMaterial.of("flame")), () -> ConfigManager.getConfig().enableFireCharge);
    public static final ArmorTrimEffect GLOWSTONE_DUST = of(TrimMaterial.of(Items.GLOWSTONE_DUST).or(TrimMaterial.of("glowstone")), () -> ConfigManager.getConfig().enableGlowstoneDust);
    public static final ArmorTrimEffect LEATHER = of(TrimMaterial.of(Items.LEATHER), () -> ConfigManager.getConfig().enableLeather);
    public static final ArmorTrimEffect NETHER_BRICK = of(TrimMaterial.of(Items.NETHER_BRICK).or(TrimMaterial.of("netherbrick")), () -> ConfigManager.getConfig().enableNetherBrick);
    public static final ArmorTrimEffect PRISMARINE_SHARD = of(TrimMaterial.of(Items.PRISMARINE_SHARD).or(TrimMaterial.of("prismarine")), () -> ConfigManager.getConfig().enablePrismarineShard);
    public static final ArmorTrimEffect RABBIT_HIDE = of(TrimMaterial.of(Items.RABBIT_HIDE).or(TrimMaterial.of("rabbit")), () -> ConfigManager.getConfig().enableRabbitHide);
    public static final ArmorTrimEffect SLIME_BALL = of(TrimMaterial.of(Items.SLIME_BALL).or(TrimMaterial.of("slime")), () -> ConfigManager.getConfig().enableSlimeBall);
    public static final ArmorTrimEffect ENCHANTED_GOLDEN_APPLE = of(TrimMaterial.of(Items.ENCHANTED_GOLDEN_APPLE).or(TrimMaterial.of("rainbow")), () -> ConfigManager.getConfig().enableEnchantedGoldenApple);
