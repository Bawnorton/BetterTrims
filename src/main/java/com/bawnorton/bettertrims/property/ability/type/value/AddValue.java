...
public record AddValue(CountBasedValue value) implements TrimValueAbility {
	...
	public static final class TooltipProvider implements TrimElementTooltipProvider<AddValue> {
		@Nullable
		@Override
		public ClientTooltipComponent getTooltip(ClientLevel level, AddValue element, boolean includeCount) {
