...
public class Config {
    ...
    public static class EnchantedGoldenApple implements NestedConfigOption {
        @Expose
        @FloatOption(type = OptionType.ADDED_VANILLA, value = 1200, max = 12000, min = 1)
        public Float absorptionDelay;
        @Expose
        @FloatOption(type = OptionType.ADDED_VANILLA, value = 250, max = 12000)
        public Float absorptionDelayReduction;
        @Expose
        @IntOption(type = OptionType.ADDED_VANILLA, value = 2, max = 20)
        public Integer absorptionAmount;
        @Expose
        @IntOption(type = OptionType.ADDED_VANILLA, value = 3, max = 30)
        public Integer maxAbsorption;
    }

    public static class Silver implements NestedConfigOption {
        @Expose
        @FloatOption(type = OptionType.MODDED, value = 0.05f, max = 0.5f)
        public Float movementSpeed;
        @Expose
        @FloatOption(type = OptionType.MODDED, value = 0.05f, max = 0.5f)
        public Float jumpHeight;
        @Expose
        @FloatOption(type = OptionType.MODDED, value = 0.5f, max = 5)
        public Float attackDamage;
        @Expose
        @FloatOption(type = OptionType.MODDED, value = 0.3f, max = 3)
        public Float attackSpeed;
        @Expose
        @FloatOption(type = OptionType.MODDED, value = 0.03f, max = 0.3f)
        public Float damageReduction;
        @Expose
        @FloatOption(type = OptionType.MODDED, value = 0.25f, max = 1)
    ...
    public static class SlimeBall implements NestedConfigOption {
        ...
        @Expose
        @FloatOption(type = OptionType.ADDED_VANILLA, value = 0.25f, max = 2.5f)
        public Float knockbackIncrease;
    }

    public static class Coal implements NestedConfigOption {
        @Expose
        @BooleanOption(type = OptionType.ADDED_VANILLA, value = false)
        public Boolean disableEffectToReduceLag;
        @Expose
        @FloatOption(type = OptionType.ADDED_VANILLA, value = 5f, max = 10f)
        public Float playerDetectionRadius;
        @Expose
        @IntOption(type = OptionType.ADDED_VANILLA, value = 1, max = 10)
    ...
    public static class EnderPearl implements NestedConfigOption {
        ...
        @Expose
        @BooleanOption(type = OptionType.ADDED_VANILLA, value = true)
