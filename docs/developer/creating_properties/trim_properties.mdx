...
Trim Properties are created using json data files. See [File Structure]($file-structure/trim_property_data_files) for where these files should be located.
...
See [Components]($creating-properties/components) for more information on what types of abilities and item properties are available.
