...
See [Abilities]($creating-properties/abilities) and [Item Properties]($creating-properties/item_properties )for more information on how to define abilities and item properties.
...
| `requirements`  | object | No       | Optional requirements that must be met for the ability or property to activate. See [Requirements]($creating-properties/requirements) for more information. |
